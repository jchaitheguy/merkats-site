...
const meerkat = (size) => `<div class="mk" style="--s:${size}px;width:${size}px;height:${size * 1.12}px" aria-label="Merkat">
  ...
  <!-- big, glossy, cute-anime eyes -- but with real padding from the head edge/ears -->
  <div style="left:19%;top:25%;width:22%;height:20%;border-radius:50%;background:#5E4327;opacity:.2"></div>
  <div style="right:19%;top:25%;width:22%;height:20%;border-radius:50%;background:#5E4327;opacity:.2"></div>
  ...
  <div class="anim" style="left:23.5%;top:28.5%;width:14%;height:13%;border-radius:50%;background:#241A0E;animation:mk-look 7s ease-in-out infinite"></div>
  <div class="anim" style="right:23.5%;top:28.5%;width:14%;height:13%;border-radius:50%;background:#241A0E;animation:mk-look 7s ease-in-out infinite"></div>
  <div class="anim" style="left:25%;top:29.5%;width:4.5%;height:4.5%;border-radius:50%;background:#fff;animation:mk-look 7s ease-in-out infinite"></div>
  <div class="anim" style="right:25%;top:29.5%;width:4.5%;height:4.5%;border-radius:50%;background:#fff;animation:mk-look 7s ease-in-out infinite"></div>
  ...
  <div class="anim" style="left:21%;top:26%;width:19%;height:0;border-radius:40%;background:#D2A56B;animation:mk-blink 4.6s infinite"></div>
  <div class="anim" style="right:21%;top:26%;width:19%;height:0;border-radius:40%;background:#D2A56B;animation:mk-blink 4.6s infinite"></div>
  ...
  <div class="anim" style="left:38%;top:67%;width:24%;height:9%;overflow:hidden;animation:mk-chew 1s ease-in-out infinite">
    <div style="position:absolute;left:0;top:-70%;width:100%;height:200%;border-radius:50%;border:calc(var(--s)*0.02) solid #7A5A3A"></div>
  </div>
  <div class="anim" style="left:46%;top:75%;width:9%;height:calc(var(--s)*0.05);border-radius:45%;background:#6B3F26;animation:mk-chew 1s ease-in-out infinite"></div>
