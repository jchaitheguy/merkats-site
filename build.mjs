...
@keyframes mk-graze{0%,100%{height:calc(var(--s)*0.06)}6%,42%{height:calc(var(--s)*0.3)}48%{height:calc(var(--s)*0.06)}}
...
const meerkat = (size) => `<div class="mk" style="--s:${size}px;width:${size}px;height:${size * 1.12}px" aria-label="Merkat">
  ...
  <div class="anim" style="left:50%;bottom:30%;width:5%;height:calc(var(--s)*0.06);transform-origin:bottom;animation:mk-graze 4s ease-in-out infinite,mk-stick 0.6s ease-in-out infinite;overflow:visible">
